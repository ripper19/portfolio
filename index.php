...
<section class="myimage" id="about">
    <img src="DSC_0049.jpg" class="mine-img">
...
<section class="projects" id="projects">
    ...
    <div class="projects-container">
        <div class="project-container project-card">
            <img src="pic.PNG" class="project-pic">
        ...
        <div class="project-container project-card">
            <img src="admin.PNG" class="project-pic">
        ...
        <div class="project-container project-card">
            <img src="bur.PNG" class="project-pic">
        ...
        <div class="project-container project-card">
            <img src="do.PNG" class="project-pic">
